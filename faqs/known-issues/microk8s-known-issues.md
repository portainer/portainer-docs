...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/Dalese9Lv4CX6YKS1s45/faqs/known-issues/microk8s-known-issues
---

# MicroK8s Known Issues

{% hint style="warning" %}
MicroK8s cluster management functionality has been removed from Portainer from version 2.41.0.
{% endhint %}
