...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/Dalese9Lv4CX6YKS1s45/faqs/known-issues/edge-stacks-do-not-support-authenticating-to-deploy-applications-from-private-registries
---
