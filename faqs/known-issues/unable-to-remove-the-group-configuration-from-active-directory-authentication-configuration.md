...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/MdgxA76kWxcRmwybM8Ft/faqs/known-issues/unable-to-remove-the-group-configuration-from-active-directory-authentication-configuration
---
