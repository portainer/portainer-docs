...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/j6QEqM3Sd94bdPsX4HaN/faqs/known-issues/unable-to-remove-the-group-configuration-from-active-directory-authentication-configuration
---
