...
## Current and planned releases <a href="#current-and-planned-releases" id="current-and-planned-releases"></a>

Each stream (LTS and STS) will have a number of patch releases throughout it’s life.

### Current releases <a href="#current-releases" id="current-releases"></a>
