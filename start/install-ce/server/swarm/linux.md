...
```
curl -L https://downloads.portainer.io/ce2-22/portainer-agent-stack.yml -o portainer-agent-stack.yml
```
...
2db7dd4bfba0   portainer/portainer-ce:2.22.0   "/portainer -H tcp:/…"   About a minute ago   Up About a minute   8000/tcp, 9443/tcp   portainer_portainer.1.gpuvu3pqmt1m19zxfo44v7izx
```
