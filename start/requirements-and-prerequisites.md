...
| --------------------------------------------------------------- | ------------------ | -------------- | ------------------ | -------------- | -------------------------------------------------------------------------------------------------------------------------- |
| [Business 2.39.8 LTS](../release-notes.md#release-2.39.6-lts)   | Sept 17, 2026      | 28.5.1 29.8.1  | 1.34 1.35 1.36     | 5.8.5          | [ARM64](architecture.md), x86\_64                                                                                          |
...
| Portainer Version    | Release Date       | Docker Version | Kubernetes Version | Podman Version | Architectures                     |
| -------------------- | ------------------ | -------------- | ------------------ | -------------- | --------------------------------- |
| Community 2.39.8 LTS | Sept 17, 2026      | 28.5.1 29.8.1  | 1.34 1.35 1.36     | 5.8.5          | [ARM64](architecture.md), x86\_64 |
