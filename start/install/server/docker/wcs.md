...
{% hint style="danger" %}
You are viewing documentation for an **older version** of Portainer. We highly recommend using the [latest version](https://docs.portainer.io/start/install/server/docker/wcs) of our documentation for install instructions.
{% endhint %}
