...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-25/portainer.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-25/portainer-lb.yaml
```
