...
```
curl https://downloads.portainer.io/ee2-16/portainer_windows_stack.yml -o portainer-windows-stack.yml
```
{% endtab %}

{% tab title="Community Edition" %}
```
curl https://downloads.portainer.io/ce2-16/portainer_windows_stack.yml -o portainer-windows-stack.yml
```
{% endtab %}
{% endtabs %}
