...
* You are running a single manager node in your swarm. If you have more than one, please [read this FAQ](../../../../faqs/installing/how-can-i-ensure-portainers-configuration-is-retained.md) before proceeding.
...
{% hint style="info" %}
By default, Portainer generates and uses a self-signed SSL certificate to secure port `9443`. Alternatively you can provide your own SSL certificate [during installation](../../../../advanced/ssl.md#using-your-own-ssl-certificate-on-docker-swarm) or [via the Portainer UI](../../../../admin/settings/general.md#ssl-certificate) after installation is complete.
{% endhint %}
