...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/Dalese9Lv4CX6YKS1s45/start/upgrade/kubernetes
---

# Updating on Kubernetes

{% hint style="info" %}
Always match the agent version to the Portainer Server version. In other words, when you're installing or updating to Portainer 2.42.0 make sure all of the agents are also on version 2.42.0.
{% endhint %}
