...
{% hint style="info" %}
Always match the agent version to the Portainer Server version. In other words, when you're installing or updating to Portainer 2.22.0 make sure all of the agents are also on version 2.22.0.
{% endhint %}
...
helm upgrade -n portainer portainer portainer/portainer \
    --set enterpriseEdition.image.tag=2.22.0
```
{% endtab %}
...
```
https://downloads.portainer.io/ee2-22/portainer.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-22/portainer.yaml
```
...
```
https://downloads.portainer.io/ee2-22/portainer-agent-k8s-nodeport.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-22/portainer-agent-k8s-nodeport.yaml
```
...
```
https://downloads.portainer.io/ee2-22/portainer-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-22/portainer-lb.yaml
```
...
```
https://downloads.portainer.io/ee2-22/portainer-agent-k8s-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-22/portainer-agent-k8s-lb.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-22/portainer.yaml
```

**Community Edition:**

```
kubectl apply -n portainer -f https://downloads.portainer.io/ce2-22/portainer.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-22/portainer-agent-k8s-nodeport.yaml
```

**Community Edition:**

```
kubectl apply -n portainer -f https://downloads.portainer.io/ce2-22/portainer-agent-k8s-nodeport.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-22/portainer-lb.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-22/portainer-agent-k8s-lb.yaml
```

**Community Edition:**

```
kubectl apply -n portainer -f https://downloads.portainer.io/ce2-22/portainer-agent-k8s-lb.yaml
```
