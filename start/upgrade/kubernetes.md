...
```
https://downloads.portainer.io/ee2-17/portainer.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-17/portainer.yaml
```
...
```
https://downloads.portainer.io/ee2-17/portainer-agent-k8s-nodeport.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-17/portainer-agent-k8s-nodeport.yaml
```
...
```
https://downloads.portainer.io/ee2-17/portainer-lb.yaml
```
...
```
https://downloads.portainer.io/ee2-17/portainer-agent-k8s-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-17/portainer-agent-k8s-lb.yaml
```
