...
{% hint style="info" %}
Always match the agent version to the Portainer Server version. In other words, when you're installing or upgrading to Portainer 2.16.0 make sure all of the agents are also on version 2.16.0.
{% endhint %}
...
```
https://downloads.portainer.io/ee2-16/portainer.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-16/portainer.yaml
```
...
```
https://downloads.portainer.io/ee2-16/portainer-agent-k8s-nodeport.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-16/portainer-agent-k8s-nodeport.yaml
```
...
```
https://downloads.portainer.io/ee2-16/portainer-lb.yaml
```
...
```
https://downloads.portainer.io/ee2-16/portainer-agent-k8s-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-16/portainer-agent-k8s-lb.yaml
```
