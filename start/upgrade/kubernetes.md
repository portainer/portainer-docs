...
helm upgrade -n portainer portainer portainer/portainer \
    --set enterpriseEdition.image.tag=2.23.0
```
{% endtab %}
...
```
https://downloads.portainer.io/ee2-23/portainer.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-23/portainer.yaml
```
...
```
https://downloads.portainer.io/ee2-23/portainer-agent-k8s-nodeport.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-23/portainer-agent-k8s-nodeport.yaml
```
...
```
https://downloads.portainer.io/ee2-23/portainer-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-23/portainer-lb.yaml
```
...
```
https://downloads.portainer.io/ee2-23/portainer-agent-k8s-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-23/portainer-agent-k8s-lb.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-23/portainer.yaml
```

**Community Edition:**

```
kubectl apply -n portainer -f https://downloads.portainer.io/ce2-23/portainer.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-23/portainer-agent-k8s-nodeport.yaml
```

**Community Edition:**

```
kubectl apply -n portainer -f https://downloads.portainer.io/ce2-23/portainer-agent-k8s-nodeport.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-23/portainer-lb.yaml
```
...
```
kubectl apply -n portainer -f https://downloads.portainer.io/ee2-23/portainer-agent-k8s-lb.yaml
```

**Community Edition:**

```
kubectl apply -n portainer -f https://downloads.portainer.io/ce2-23/portainer-agent-k8s-lb.yaml
```
