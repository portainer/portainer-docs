...
{% hint style="info" %}
Always match the agent version to the Portainer Server version. In other words, when you're installing or upgrading to Portainer 2.13 make sure all of the agents are also on version 2.13.
{% endhint %}
...
```
https://downloads.portainer.io/ee2-13/portainer-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-13/portainer-lb.yaml
```
...
```
https://downloads.portainer.io/ee2-13/portainer-agent-k8s-lb.yaml
```

**Community Edition:**

```
https://downloads.portainer.io/ce2-13/portainer-agent-k8s-lb.yaml
```
