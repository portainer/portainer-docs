...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bTMBgpWwhtAF08xfMYTs/start/upgrade/swarm
---

# Updating on Docker Swarm

{% hint style="info" %}
Always match the agent version to the Portainer Server version. In other words, when you're installing or updating to Portainer 2.37.0 make sure all of the agents are also on version 2.37.0.
{% endhint %}
...
tb9gtxc647fw   portainer-agent_agent   global       3/3        portainer/agent:2.37.0
m3a3mtuy55ed   portainer_portainer     replicated   1/1        portainer/portainer-ee:2.37.0  *:8000->8000/tcp, *:9000->9000/tcp
```
