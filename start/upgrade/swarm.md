...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/udjBY77rL45c6FTs07xf/start/upgrade/swarm
---
...
tb9gtxc647fw   portainer-agent_agent   global       3/3        portainer/agent:2.38.0
m3a3mtuy55ed   portainer_portainer     replicated   1/1        portainer/portainer-ee:2.38.0  *:8000->8000/tcp, *:9000->9000/tcp
```
