...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/MdgxA76kWxcRmwybM8Ft/user/edge/templates/application
---
...
To create an Edge stack from a template, click the template in the list. You will be taken to the [Edge Stack creation page](../stacks/add/) with the template pre-filled.
