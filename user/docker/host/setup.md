...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bTMBgpWwhtAF08xfMYTs/user/docker/host/setup
---
...
{% hint style="warning" %}
If access to an environment is being managed by a setup [policy](../../../admin/environments/policies/), access can not be changed or modified from this view as the policy access takes precedence.&#x20;
{% endhint %}
