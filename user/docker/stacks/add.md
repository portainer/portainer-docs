...
<figure><img src="../../../.gitbook/assets/2.15-docker_add_stack_git_auth.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/2.15-docker_add_stack_git_auto_update_polling.png" alt=""><figcaption><p>Automatic updates when using polling</p></figcaption></figure>

<figure><img src="../../../.gitbook/assets/2.15-docker_add_stack_git_auto_update_webhook.png" alt=""><figcaption><p>Automatic updates when using webhooks</p></figcaption></figure>

| Field/Option       | Overview                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Pull latest image  | Enable this setting to always pull the latest version of container images when updating the stack. This is equivalent to the `--pull=always` flag for `docker run`.                                                                                                                                                                                                                                                                                                                                                                                                |
...
<figure><img src="../../../.gitbook/assets/2.15-docker_add_stack_git_pull_latest_image.png" alt=""><figcaption></figcaption></figure>
