...
{% hint style="info" %}
For more detail on how automatic updates function under the hood, have a look at [this FAQ entry](../../../faq/troubleshooting.md#how-do-automatic-updates-for-stacks-applications-work).
{% endhint %}
...
![Automatic updates when using polling](../../../.gitbook/assets/2.12-stacks-add-automatic-polling.png)

![Automatic updates when using a webhook](../../../.gitbook/assets/2.12-stacks-add-automatic-webhook.png)
...
![](../../../.gitbook/assets/2.12-stacks-add-pull-latest-force.png)
