...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bTMBgpWwhtAF08xfMYTs/user/observability/alerting
---
...
To access Alerting once the feature is enabled under [additional functionality](../../admin/settings/general.md#additional-functionality), click on **Alerting** under **Observability** in the left menu.
