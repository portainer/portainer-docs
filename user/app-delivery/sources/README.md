...
From this view, admin users can [add a new source](add-a-new-source/), monitor the connectivity status of each source, and manage credentials - maintain consistency across the platform without navigating between multiple configuration screens.&#x20;
