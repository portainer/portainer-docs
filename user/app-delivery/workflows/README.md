...
| Element       | Description                                                                                                                                                                                                                                                                                                                   |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Workflow name | <p>The name of the stack/application. Click on the stack name to navigate directly to the stack or application.<br>Note that if no name was provided at creation time, this name will be auto-generated as <code>'&#x3C;manifest path>' from source '&#x3C;source name>' in environment '&#x3C;environment name>'</code>.</p> |
