...
The remaining dashboard is made up of tiles showing the number of [namespaces](../namespaces/), [applications](../applications/), [services](../networking/services.md), [ingresses](../networking/ingresses/), [ConfigMaps](../configurations/#configmaps), [secrets](../configurations/#secrets), [volumes](../volumes/), [policies](../../../admin/environments/policies/), and [GPUs](../gpu.md) that make up the environment.

<figure><img src="../../../.gitbook/assets/2.44-dashboard-view-1.png" alt=""><figcaption></figcaption></figure>
