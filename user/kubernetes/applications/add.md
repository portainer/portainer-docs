...
There are two ways to add a new application: manually by using a form, or automatically by [using a file](manifest.md). This article explains how to add an application manually.
