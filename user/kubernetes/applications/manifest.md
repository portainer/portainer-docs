# Add a new application using a file

There are two ways to add a new application: [manually by using a form](add.md) or automatically by using a file. This article explains how to add an application using a file.

{% hint style="info" %}
Files aren't just for applications - you can also deploy namespaces, ingresses, ConfigMaps, secrets, volumes and more using a file.
{% endhint %}

First, from the left hand menu select **Applications** then click **Create from file**.
