...
Once you have selected a namespace for your Helm deployment you will need to specify a **Name** for your deployment. Next, select a registry to pull charts from in the registry dropdown. Portainer will then pull the chart list from the selected registry and display them below. Select a chart to use from the list provided. You can search within the list and filter by category.

{% hint style="info" %}
Support for OCI format Helm charts is in development and will be available in a future release.
{% endhint %}

<figure><img src="../../../.gitbook/assets/2.31-kubernetes-applications-create-helm-deployto.png" alt=""><figcaption></figcaption></figure>
