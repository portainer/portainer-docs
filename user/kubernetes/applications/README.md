...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bTMBgpWwhtAF08xfMYTs/user/kubernetes/applications
---
...
<figure><img src="../../../.gitbook/assets/2.35-kubernetes-applications-list.png" alt=""><figcaption></figcaption></figure>
...
{% content-ref url="edit-helm.md" %}
[edit-helm.md](edit-helm.md)
{% endcontent-ref %}
