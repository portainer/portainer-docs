...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/MdgxA76kWxcRmwybM8Ft/user/kubernetes/volumes
---
...
{% hint style="info" %}
Volumes can also be added [using a manifest](../applications/manifest/) by clicking **Create from manifest**.
{% endhint %}
