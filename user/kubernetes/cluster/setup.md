...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/MdgxA76kWxcRmwybM8Ft/user/kubernetes/cluster/setup
---
...
This setting allows you to specify a window within which [GitOps updates](../applications/manifest/#gitops-updates) to your applications can be applied.
