...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/Dalese9Lv4CX6YKS1s45/user/account-settings
---
...
<figure><img src="../.gitbook/assets/2.42-account-settings-1.gif" alt=""><figcaption></figcaption></figure>

## Changing the theme

Portainer supports light, dark, and high-contrast themes, with an option to automatically match your system theme. Theme selection applies to your user account only.

You can choose a theme from the username dropdown in the top navigation bar, or from within your account settings. Changes are applied immediately.

<figure><img src="../.gitbook/assets/2.24-theme.png" alt=""><figcaption></figcaption></figure>
