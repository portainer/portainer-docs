...
* The minimum TLS version of Portainer was changed from 1.2 to 1.3. If you are running a proxy in front of Portainer you will need to ensure it is configured to accept TLS 1.3.
