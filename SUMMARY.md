...
* [Welcome](README.md)
* [What's new in version 2.17](whats-new.md)
...
* [Add an environment to an existing installation](start/agent/README.md)
  * [Docker Standalone](start/agent/docker/README.md)
    * [Install Portainer Agent with Docker on Linux](start/agent/docker/linux.md)
    * [Install Portainer Agent with Docker on WSL / Docker Desktop](start/agent/docker/wsl.md)
    * [Install Portainer Agent with Docker on Windows Container Service](start/agent/docker/wcs.md)
  * [Docker Swarm](start/agent/swarm/README.md)
    * [Install Portainer Agent with Docker Swarm on Linux](start/agent/swarm/linux.md)
    * [Install Portainer Agent with Docker Swarm on WSL / Docker Desktop](start/agent/swarm/wsl.md)
    * [Install Portainer Agent with Docker Swarm on Windows Container Service](start/agent/swarm/wcs.md)
  * [Kubernetes](start/agent/kubernetes/README.md)
    * [Import an existing Kubernetes environment](start/agent/kubernetes/import.md)
    * [Install Portainer Agent on your Kubernetes environment](start/agent/kubernetes/baremetal.md)
    * [Install Portainer Agent with Kubernetes on WSL / Docker Desktop](start/agent/kubernetes/wsl.md)
  * [Azure ACI](start/agent/aci.md)
  * [Nomad](start/agent/nomad.md)
  * [KaaS](start/agent/kaas/README.md)
    * [Civo](start/agent/kaas/civo.md)
    * [Linode](start/agent/kaas/linode.md)
    * [DigitalOcean](start/agent/kaas/digitalocean.md)
    * [Google Cloud](start/agent/kaas/gke.md)
    * [AWS](start/agent/kaas/eks.md)
    * [Azure](start/agent/kaas/aks.md)
  * [Edge Agent](start/agent/edge.md)
...
* [Settings](admin/settings/README.md)
  ...
  * [Edge Compute](admin/settings/edge/README.md)
    * [Edge Devices](admin/settings/edge/devices/README.md)
      * [FDO](admin/settings/edge/devices/fdo.md)
      * [OpenAMT](admin/settings/edge/devices/openamt.md)
