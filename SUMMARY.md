...
* [Welcome](README.md)
* [What's new in version 3.0](whats-new.md)
...
* [Kubernetes](user/kubernetes/README.md)
  ...
  * [More Resources](user/kubernetes/more-resources/README.md)
    ...
    * [Image Vulnerabilities](user/kubernetes/more-resources/image-vulnerabilities.md)
...
* [Edge Compute](user/edge/README.md)
  ...
  * [Edge Stacks](user/edge/stacks/README.md)
    * [Add a new Edge Stack](user/edge/stacks/add/README.md)
      * [Compose deployment](user/edge/stacks/add/compose-deployment.md)
      * [Kubernetes deployment](user/edge/stacks/add/kubernetes-deployment.md)
      * [Helm chart deployment](user/edge/stacks/add/helm-chart-deployment.md)
...
* [Environment-related](admin/environments/README.md)
  ...
  * [Add a new environment](admin/environments/add/README.md)
    ...
    * [Add a KubeSolo (Edge) environment](admin/environments/add/add-a-kubesolo-edge-environment/README.md)
      * [Install Edge Agent Standard on KubeSolo](admin/environments/add/add-a-kubesolo-edge-environment/install-edge-agent-standard-on-kubesolo.md)
      * [Install Edge Agent Async on KubeSolo](admin/environments/add/add-a-kubesolo-edge-environment/install-edge-agent-async-on-kubesolo.md)
  ...
  * [Policies](admin/environments/policies/README.md)
    * [Kubernetes Policies](admin/environments/policies/kubernetes-policies/README.md)
      ...
      * [Create a Kubernetes network security policy](admin/environments/policies/kubernetes-policies/create-a-kubernetes-network-security-policy.md)
      ...
      * [Create a Kubernetes vulnerability scanning policy](admin/environments/policies/kubernetes-policies/create-a-kubernetes-vulnerability-scanning-policy.md)
...
* [Add-ons](admin/add-ons/README.md)
  * [Installing an add-on](admin/add-ons/installing-an-add-on.md)
  * [Managing an installed add-on](admin/add-ons/managing-an-installed-add-on.md)
...
* [Troubleshooting](faqs/troubleshooting/README.md)
  ...
  * [Stacks, deployments and updates](faqs/troubleshooting/stacks-deployments-and-updates/README.md)
    ...
    * [Why did my API client start getting 409 errors after upgrading?](faqs/troubleshooting/stacks-deployments-and-updates/why-did-my-api-client-start-getting-409-errors-after-upgrading.md)
