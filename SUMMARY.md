...
* [Welcome](README.md)
* [What's new in version 2.37](whats-new.md)
...
* [Environment-related](admin/environments/README.md)
  ...
  * [Policies](admin/environments/policies/README.md)
    * [Create a Kubernetes RBAC policy](admin/environments/policies/kubernetes-rbac-policy.md)
    * [Create a Kubernetes security policy](admin/environments/policies/kubernetes-security-policy.md)
    * [Create a Kubernetes setup policy](admin/environments/policies/kubernetes-setup-policy.md)
    * [Create a Kubernetes registry policy](admin/environments/policies/kubernetes-registry-policy.md)
    * [Create a Docker, Swarm or Podman RBAC policy](admin/environments/policies/rbac-policy.md)
    * [Create a Docker, Swarm or Podman security policy](admin/environments/policies/security-policy.md)
    * [Create a Docker, Swarm or Podman setup policy](admin/environments/policies/setup-policy.md)
    * [Create a Docker, Swarm or Podman registry policy](admin/environments/policies/registry-policy.md)
