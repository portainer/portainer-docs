...
| Enable node shell for admins                             | By default, users can not [open a shell](../../../../user/kubernetes/cluster/details/#nodes) directly on any Kubernetes node's host OS. Enable this option to allow admin users to do so.                                                                                                                                                                                                       |
...
<figure><img src="../../../../.gitbook/assets/2.44-kubernetes-security-policy.png" alt=""><figcaption></figcaption></figure>
