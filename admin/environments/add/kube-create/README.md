...
You can create a Kubernetes cluster on your existing infrastructure directly from the Portainer UI.
...
At present, we support deploying Talos Kubernetes via Omni:
