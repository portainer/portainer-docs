...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bTMBgpWwhtAF08xfMYTs/admin/environments/add/docker/agent
---
...
<figure><img src="../../../../.gitbook/assets/2.36.0-docker-SA-agent.png" alt=""><figcaption></figcaption></figure>
