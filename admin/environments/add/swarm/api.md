...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/xdTQRpMuktD2l0URtOJO/admin/environments/add/swarm/api
---
...
Next, select **Docker Swarm** as the environment type then click **Start Wizard**. Under **More options**, select the **API** option and your platform, then enter the environment details using the table below as a guide:
