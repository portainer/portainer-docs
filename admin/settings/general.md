...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/udjBY77rL45c6FTs07xf/admin/settings/general
---
...
| Policy Based Management | Toggle this on to enable the Policy Based Management feature. Enabling this will add a new menu item [policies](../../user/policy-based-management/policies/) within the Environment-related menu.                                                                                                                       |
