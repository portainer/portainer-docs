...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bTMBgpWwhtAF08xfMYTs/admin/settings/general
---
...
| Field/Option     | Overview                                                                                                                                                                                                                                                                                                       |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fleet management | <p>Toggle this on to enable the Fleet management feature. Enabling this will add a new menu item <a href="../environments/policies/">policies</a> within the Environment-related menu. <br><strong>As this is an experimental feature we do not recommend enabling it on production environments.</strong></p> |

<figure><img src="../../.gitbook/assets/2.37.0-Fleet-management-toggle.png" alt=""><figcaption></figcaption></figure>
