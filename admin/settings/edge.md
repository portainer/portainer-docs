...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/MdgxA76kWxcRmwybM8Ft/admin/settings/edge
---
...
This section controls the configuration of the [Intel OpenAMT](/broken/pages/5ZCkvS2nVsDo03ojOshw) functionality in Portainer.
