...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/j6QEqM3Sd94bdPsX4HaN/admin/user/roles
---
...
* **Operator** has visibility across all resources in an environment. In Kubernetes, an Operator can redeploy or rollback applications and edit configurations, but cannot create, edit, or delete applications, volumes, or namespaces. In Docker, an Operator cannot create, edit, delete, start, or stop any resource, but can view logs, console/attach into containers, change resource ownership, and manage registry repositories.
...
* **Namespace Operator** has operational control over existing applications and configurations within assigned namespaces - including redeploying or rolling back applications and editing configurations - but not creating, editing or deleting applications, volumes, or namespaces. This role mirrors Operator, but scoped to specific namespaces rather than the entire environment, and is only available for Kubernetes environments.
