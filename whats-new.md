...
This release adds initial Docker 29 support to Portainer. Docker 29 introduced some significant breaking changes that were not compatible with Portainer, and in this release we've made adjustments to our code to accommodate those breaking changes. While not all new Docker 29 features and changes are available as of yet in Portainer, this should get users up and running with the latest Docker version.
