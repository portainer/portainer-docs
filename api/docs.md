...
You can find our API documentation here: [2.45.0 API Documentation](https://api-docs.portainer.io/?edition=ee\&version=2.45.0).

We also have some examples of API usage here:
