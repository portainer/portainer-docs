...
docker run -d -p 9443:9443 -p 8000:8000 \
    ...
    portainer/portainer-ce:2.11.0 --sslcert /certs/live/yourdomain/cert.pem --sslkey /certs/live/yourdomain/privkey.pem
```
...
```
curl -L https://downloads.portainer.io/CE2.11/portainer-agent-stack-ssl.yml \
...
```
curl https://downloads.portainer.io/CE2.11/portainer-windows-stack-ssl.yml `
    -o portainer-agent-stack.yml
```
{% endtab %}
{% endtabs %}
