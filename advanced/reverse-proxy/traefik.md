...
{% hint style="warning" %}
This deployment assumes you are running one manager node. If you are using multiple managers we advise [reading this FAQ entry](broken-reference) before proceeding.
{% endhint %}
