...
| `--edge-portainer-url`                                 | A HTTPS URL that Edge agents connect back to (e.g. `https://edge.example.com:9443`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `--edge-trust-on-first-connect`                        | A boolean that auto-trusts Edge agents the first time they connect, bypassing the manual-approval [waiting room](../user/edge/waiting-room.md).                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `--edge-tunnel-server-address`                         | The `host:port` that Edge agents' reverse tunnels connect to (e.g. `edge.example.com:8000`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `--license-key`                                        | Specifies the license key to use.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `--no-setup-token`                                     | Disables the need for a setup token at startup. Use this only when the instance runs on a network you fully control and trust.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `--setup-token <value>`                                | Supply your own setup token on startup instead of the autogenerated one. Useful for scripted or automated setup.                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `--sslcacert`                                          | Specifies the path to the certificate authority (CA) certificate used to validate the Edge Agent certificate. (**deprecated**, use [mTLS](mtls.md) instead)                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `--trusted-origins`                                    | <p>Specify (in a comma-separated list) the domain(s) used to access Portainer when it is behind a reverse proxy. Use this option if Portainer is behind a reverse proxy and you are getting "Origin invalid" errors.<br>Note that <code>PORTAINER_TRUSTED_ORIGINS</code> entries must now be full URLs including scheme (e.g. https://portainer.example.com) and may include port number.</p>                                                                                                                                                                          |
| `--trusted-proxies`                                    | Specify (in a comma-separated list) the IPs/CIDRs of any forwarding proxies you have in front of Portainer. This is used to determine whether the forwarding headers (`X-Forwarded-For` or `Forwarded`) can be trusted (as they come from a trusted proxy) to accurately establish the client IP for use in the Origin field of the [Authentication logs](../admin/logs/authentication.md). If the source IP is not in the trusted proxies list, then it is used directly in the Origin field and Portainer does not consider any forwarding headers for that request. |
