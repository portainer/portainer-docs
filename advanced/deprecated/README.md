...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/MdgxA76kWxcRmwybM8Ft/advanced/deprecated
---
...
| -------------------------------------------------------------------------------------------------------------------------- | ---------- | ------ |
| OpenAMT integration                                                                                                        | 2.36.0     | TBD    |
...
| [Create a MicroK8s cluster](/broken/pages/MuOmi4kbFIqcLJ3lJENp) feature                                                    | 2.30.0     | TBD    |
